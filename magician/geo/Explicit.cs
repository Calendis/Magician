...
public class Explicit : Node
{
    ...
    int[] axes;
    Sampling? sampling;
    public Explicit(IRelation r, double x, double y, double z, double inScale, double outScale, int domain, int[] axes, Sampling? sampling, params (double, double, double)[] rangeResos) : base(x, y, z)
    {
        relation = r;
    ...
    // TODO: we can use named arguments instead of having a million ctors
    public Explicit(IRelation r, double x, double y, double z, double inScale, double outScale, int[] axes, Sampling? sampling, params (double, double, double)[] rangeResos) : this(r, x, y, z, inScale, outScale, 2, axes, sampling, rangeResos) { }
    public Explicit(IRelation r, double x, double y, double z, double inScale, double outScale, int domain, int[] axes, params (double, double, double)[] rangeResos) : this(r, x, y, z, inScale, outScale, domain, axes, null, rangeResos) { }
    public Explicit(IRelation r, double x, double y, double z, double inScale, double outScale, int[] axes, params (double, double, double)[] rangeResos) : this(r, x, y, z, inScale, outScale, 2, axes, null, rangeResos) { }
    public Explicit(IRelation r, double x, double y, double z, double inScale, double outScale, int domain, Sampling sampling, params (double, double, double)[] rangeResos) : this(r, x, y, z, inScale, outScale, domain, defaultAxes, sampling, rangeResos) { }
    public Explicit(IRelation r, double x, double y, double z, double inScale, double outScale, Sampling sampling, params (double, double, double)[] rangeResos) : this(r, x, y, z, inScale, outScale, 2, defaultAxes, sampling, rangeResos) { }
    public Explicit(IRelation r, double x, double y, double z, double inScale, double outScale, int domain, params (double, double, double)[] rangeResos) : this(r, x, y, z, outScale, inScale, domain, defaultAxes, null, rangeResos) { }
    public Explicit(IRelation r, double x, double y, double z, double inScale, double outScale, params (double, double, double)[] rangeResos) : this(r, x, y, z, inScale, outScale, 2, defaultAxes, null, rangeResos) { }
    public Explicit(IRelation r, double x, double y, double z, double scale, params (double, double, double)[] rangeResos) : this(r, x, y, z, scale, scale, 2, defaultAxes, null, rangeResos) { }
    public Explicit(IRelation r, double x, double y, double z, double inScale, double outScale, int domain, int[] axes, Sampling? sampling, double reso, params (double, double)[] ranges) : this(r, x, y, z, inScale, outScale, domain, axes, sampling, ranges.Select(r => (r.Item1, r.Item2, reso)).ToArray()) { }
    ...
    public void Refresh()
    {
        GenMesh(GenRegions(maxOuts, sampling), (int)((1+range[0].Item2 - range[0].Item1) / resolution[0]));
    }
    public List<(Mesh.Region, double[], IVal)> GenRegions(int maxOuts, Sampling? sampling)
    {
        ...
        do
        {
            ...
            {
                IVal tr = sampling.Evaluate(inVals[0] / (1+range[0].Item2 - range[0].Item1), inVals[1]);
                if (tr.Dims < 2)
                    tr.Push(0);
        ...
        int width = (int)((1+range[0].Item2 - range[0].Item1) / resolution[0]);
